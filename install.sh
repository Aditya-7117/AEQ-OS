...
echo "  Windsurf:     see templates/windsurf-rules.md"
echo "  Copilot:      see templates/copilot-instructions.md"
echo "  Cline/Roo:    see templates/clinerules.md"
echo "  Aider:        see templates/aider-conventions.md"
echo "  Any tool that reads a project-root AGENTS.md natively needs no extra step —"
echo "  or run 'scripts/adopt-project.sh <project>' to stamp one project explicitly,"
echo "  which also covers teammates who never ran this installer."
echo
echo "Verify: grep -rn \"QT-STOP-3\" ~/.ai_os/  should return a match."
echo "Or run: scripts/status.sh  for a full wiring report (global + project-root)."
