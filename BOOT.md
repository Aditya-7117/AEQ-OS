...
Version 1.5.0 · Model-agnostic (Claude Code, Google Antigravity, Cursor, Windsurf, GitHub Copilot, Cline/Roo Code, Aider, GPT, local/open-source models, any AGENTS.md-reading tool)
